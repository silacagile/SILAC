...
public class RegistrarResultado_1 extends JFrame {
...
jPanel2Layout.setHorizontalGroup(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarResultado_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarResultado_1().setVisible(true);
            }
        });
    }
